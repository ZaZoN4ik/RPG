...
const CONFIG = {
    allies: [
        ...
        { id: 'archer', name: 'Лучник', baseDps: 12, cost: 300, icon: '🏹' },
        { id: 'mage', name: 'Маг', baseDps: 55, cost: 1500, icon: '🧙‍♂️' },
        { id: 'knight', name: 'Рыцарь', baseDps: 250, cost: 6000, icon: '🐎' }
    ],
    itemNames: {
        prefixes: ["Ржавый", "Железный", "Стальной", "Золотой", "Демонический", "Драконий", "Эфирный"],
        weapons: ["Меч", "Топор", "Молот", "Кинжал", "Посох"],
        armors: ["Нагрудник", "Шлем", "Щит", "Плащ"]
    }
};
